...
class PostreCrear(SuccessMessageMixin, CreateView): 
    ...
    form = Postres
    fields = "__all__" 
    success_message = 'Created OK !' # Mostramos este Mensaje luego de Crear un Postre     
...
class PostreActualizar(SuccessMessageMixin, UpdateView): 
    ...
    form = Postres
    fields = "__all__"  
    success_message = 'Updated OK !' # Mostramos este Mensaje luego de Editar un Postre 
...
class PostreEliminar(SuccessMessageMixin, DeleteView): 
    ...
    def get_success_url(self): 
        success_message = 'Deleted OK !' # Mostramos este Mensaje luego de Editar un Postre 
